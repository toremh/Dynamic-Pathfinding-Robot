...
void TimerHandler1() {
  ...
  */
    ...
    //temp = signalADCL;
    temp = 204500 * pow(signalADCL, -1.249);
    ...
    //temp = signalADCR;
    temp = 517080 * pow(signalADCR, -1.399);
    ...
    if (positionSet) {
      ...
      if (switched) {
        if (yValue < 1000) {
          yValue = 1200 - (distIRR + handOffOffSet * (1000 - yValue) / 400.0);
        } else if (yValue <= 1200) {
          yValue = 1200 - distIRR;
        }
      } else {
...
/*
  ...
  float endDistance = 170.0;
  float startDistance = 1820.0;
  float parallelT = 160;
  ...
  parallelT += increment;
  goStrafe(endDistance, 0.55, 0.09, 0.75, 15, parallelT, 1);
  ...
  goStraight(endDistance, KpForward, KiForward, 0.75, 20, parallelT, 1);
  ...
  goStraight(startDistance, KpReturn, KiForward, 0.75, 20, parallelT, 1);
