...
volatile float sonarOffset = 0;
volatile int timerCounter;

volatile int8_t xValue = 0;
volatile int8_t yValue = 1;
volatile int8_t debugValue = 2;
...
void TimerHandler1() {
  ...
  */
    ...
    sumIRL += temp;
    distIRL = (sumIRL / ((float)avgSize)) + sonarOffset;
    ...
    sumIRR += temp;
    distIRR = (sumIRR / ((float)avgSize)) + sonarOffset;
...
void serialOutputMonitor(int8_t Value1, int8_t Value2, int8_t Value3)
{
  String Delimiter = ", ";
...
void serialOutputPlotter(int8_t Value1, int8_t Value2, int8_t Value3)
{
  String Delimiter = ", ";
...
void bluetoothSerialOutputMonitor(int8_t Value1, int8_t Value2, int8_t Value3)
{
  disable_motors();
  String Delimiter = "                        ";
...
void serialOutput(int8_t Value1, int8_t Value2, int8_t Value3)
{
  if (OUTPUTMONITOR)
  {
...
STATE running() {
  ...
  serialOutput(xValue, yValue, debugValue);
  delay(300);


  // delay(2000);
  // goStraight(150.0, 0.65, 0.2, 0.8, 10, 150.0, 1);
  // delay(2000);
  // goStraight(500.0, 0.65, 0.2, 0.8, 10, 150.0, 1);
  // delay(100000);
